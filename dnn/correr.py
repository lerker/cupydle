...
data_trn = dataset(os.curdir + '/Datos/OR_trn.csv', delimiter=',')
...
for l in range(0, len(salida_trn)):
    if entrada_trn[l, 0] < 0.0 and entrada_trn[l, 1] < 0.0:
        salida_trn[l] = 0.0
