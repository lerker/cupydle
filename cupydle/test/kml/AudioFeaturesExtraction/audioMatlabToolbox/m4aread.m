...
% $Header: /Users/dpwe/matlab/columbiafns/audioread/RCS/m4aread.m,v 1.2 2014/04/16 12:55:16 dpwe Exp dpwe $
...
if strcmp(FMT,'size') == 1
  ...
  Y = []; SR = 0;
  try  % don't let a failure in wavread* prevent us deleting the temp file
    if endfrm > sttfrm
    ...
    disp(['Problem reading temporary wav file: ', me.message]);
    % but continue through to deleting the temp file
  end
